      ...
      <div className="slip-paper relative overflow-hidden rounded-2xl border border-stone-200/80 shadow-[0_30px_60px_-28px_rgba(15,23,42,0.55)]">
        <div className="flex items-center gap-2.5 border-b border-stone-300/60 px-4 py-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-[13px] font-semibold leading-tight text-slate-800">Partner Laboratory</p>
            <p className="text-[9px] font-medium uppercase tracking-[0.14em] text-stone-400">Laboratory request form</p>
          </div>
          <span className="rounded border border-stone-200 px-1.5 py-0.5 text-[9px] tabular-nums text-stone-500">
            LR-4F21
          </span>
        </div>
