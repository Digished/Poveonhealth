    ...
    <div className="animate-fade-in pb-28">
      ...
      <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h2 className="text-sm font-bold text-slate-800">What does the patient need?<span className="inline-block w-1.5 h-1.5 rounded-full bg-amber-400 ml-1.5 align-middle" aria-label="required" /></h2>
        </div>
        <textarea
          ref={rawRef}
          value={rawText}
