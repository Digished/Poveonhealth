...
import { Heart, Mail, KeyRound, ArrowRight, RefreshCw, ChevronLeft } from "lucide-react";
            ...
            <form onSubmit={handleSendOtp} className="space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mb-3">
                  Enter the email associated with your lab requests. We'll send a login code.
                </p>
                <input
                  id="patient-email"
                  type="email"
